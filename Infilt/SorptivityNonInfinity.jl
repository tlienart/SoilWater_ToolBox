...
module sorptivity
	...
	#		FUNCTION : SORPTIVITY
	# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		function SORPTIVITY(θ_Ini, iSoil, hydro; ε=0.001,  Rtol=10^-4.0)
			...
			function SORPTIVITY_Ψ(Ψ, hydro, θ_Ini, iSoil)
				...
				return Sorptivity_Ψ =  kunsat.θ_2_KUNSAT(θ, iSoil, hydro) * (2.0 * (θ - θ_Ini)) / FLUXCONS_θ(θ, θ_Ini, hydro.θs[iSoil])
			end # SORPTIVITY_Ψ ~~~~~~~~~~~~~~~~~
