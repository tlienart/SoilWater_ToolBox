...
module infiltStruct
	...
	# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		function INFILTSTRUCT(N_SoilSelect)
			...
			infiltOutput = INFILT(Sorptivity, iT_TransSteady_Data, T_TransSteady_Data, Nse_Trans, Nse_Steady, Nse, FieldName)

			return infiltOutput = tool.readWrite.FIELDNAME_2_STRUCT(INFILT, infiltOutput) # Saving the FieldNames
