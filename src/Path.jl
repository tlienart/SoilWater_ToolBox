...
module paths
	...
	function PATH(iSim, opt, PathData_Hypix, PathData_SoilWater, SiteName_Hypix, SiteName_Soilwater, Soilwater_OR_Hypix⍰; Soilname=["Temporary"])
		...
		Path_Soilwater_Table    = Path_Home * "/OUTPUT/SoilWater/" * SiteName_Soilwater * "/Table/"
			...
			path.tableSoilwater.Table_KsModel        = Path_Soilwater_Table * "_"  *  path.option.ModelName * "_" *  path.option.Select  * "_" * path.tableSoilwater.Table_KsModel
			path.tableSoilwater.Table_KsModel_τ        = Path_Soilwater_Table * "_"  *  path.option.ModelName * "_" *  path.option.Select  * "_" * path.tableSoilwater.Table_KsModel_τ
		...
		# =============================================================
			...
			Plot_KsModel₀ = Path_Soilwater_Plot * "/KsModel/"
				mkpath(Plot_KsModel₀)
				path.plotSoilwater.Plot_KsModel = Plot_KsModel₀ * SiteName_Soilwater * "_"  * path.option.ModelName  * "_" *  path.option.Select  * "_" * path.plotSoilwater.Plot_KsModel
