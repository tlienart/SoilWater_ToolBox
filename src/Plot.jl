...
module plot
	...
	module lab
		...
		#		FUNCTION : HYDROPARAM
		# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			function HYDROPARAM(hydro, IdSelect, K_KΨobs, N_iZ, N_KΨobs, N_θΨobs, option, optionₘ, param, path, θ_θΨobs, Ψ_KΨobs, Ψ_θΨobs; N_Se=1000)
				...
				for iZ = param.globalparam.N_iZ_Plot_Start: min(param.globalparam.N_iZ_Plot_End, N_iZ)
					...
					#  == Plot_θ_Ψ  ==
						...
						Fig_θΨobs = scatter!(Fig[1,1], log1p.(cst.Mm_2_kPa .* Ψ_θΨobs[iZ,1:N_θΨobs[iZ]]), Float64.(θ_θΨobs[iZ,1:N_θΨobs[iZ]]), color=:red, markersize=15, marker = '■')
					...
					if "Ks" ∈ optim.ParamOpt
						...
						Fig_Kθobs = scatter!(Fig[1,2], log1p.(Ψ_KΨobs[iZ,1:N_KΨobs[iZ]].*cst.Mm_2_kPa), log1p.(K_KΨobs[iZ,1:N_KΨobs[iZ]].*cst.MmS_2_MmH), color=:red, markersize=15, marker = '■')
	...
	# 	#		FUNCTION : PLOT_θr
	# 	# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	# 	function PLOT_θr(∑Psd, N_iZ, hydro, hydroPsd, Path)
	...
	# 	# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	# 	function PLOT_IMP_MODEL(IdSelect, Rpart, N_Psd, ∑Psd, Psd, N_iZ, hydro, paramPsd, Path)
	...
	# 	# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	# 	function PLOT_PSD_θΨ(Ψ_θΨobs, Ψ_Rpart, θ_θΨobs, θ_Rpart, N_θΨobs, N_iZ, N_Psd, IdSelect, hydroPsd, hydro, Path; N_Se= 100)
	...
	# 			# Simulated 
	# 				for iΨ = 1:N_Se
	# 					θ_θΨobs_Psd[iΨ] = wrc.Ψ_2_θDual(optionₘ,Ψ_Sim[iΨ], iZ, hydroPsd)
	# 				end # iΨ 
	...
	# 	# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	# 	function PLOT_∑INFILT(IdSelect, N_Infilt, N_iZ, ∑Infilt_Obs, Tinfilt, ∑Infilt_3D, ∑Infilt_1D, infiltOutput, Path)
